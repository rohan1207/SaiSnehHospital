  ...
  return (
    <>
      <div className="fixed bottom-4 right-4 z-50 flex flex-col items-center gap-3">
        ...
        >
          ...
          <button
            ...
            className="flex items-center justify-center w-14 h-14 bg-blue-500 text-white rounded-full shadow-lg hover:bg-blue-600 transition-transform transform hover:scale-110"
      ...
      <ChatBot
        ...
        className="onHover:aria-label='Sai Sneh Hospital Assistant'"
      />
    </>
  );
};
