  ...
  return (
    <footer className="bg-gray-900 text-gray-300 text-sm">
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="flex flex-col items-center space-y-6 md:items-start">
          ...
          <p className="leading-relaxed text-gray-400 text-center md:text-left max-w-sm">
            Sai Sneh provides world-class healthcare services with experience,
            ...
            <div className="flex flex-col items-center space-y-3 text-gray-400">
              {[
                ...
                <a
                  key={link.label}
                  href={link.href}
                  className="hover:text-blue-500 transition text-center"
                >
                  {link.label}
                </a>
              ))}
        ...
        <div className="flex flex-col  space-y-8  text-left md:text-left align-left">
          ...
          <div className="flex flex-col  space-y-4 text-gray-400 w-full max-w-xs">
            <div className="flex items-start  gap-2">
              ...
              <span className="" href="">
                Pune-Satara Road, opp. PMT Bus Depot, Katraj Pune, Maharashtra,
                India 411046
              </span>
            </div>
      ...
      <div className="border-t border-gray-700 py-4 text-center text-xs text-gray-500">
        © {new Date().getFullYear()} Sai Sneh Hospital. All rights reserved.
      </div>
    </footer>
  );
};
