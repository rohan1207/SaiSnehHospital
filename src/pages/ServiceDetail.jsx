...
import serviceDetailsData from "../data/json/ServiceDetails.json";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-24">
        ...
        >
          ...
          >
            ...
            {/* Visual Elements */}
            <div className="relative h-64 bg-gradient-to-r from-blue-100 to-purple-100 rounded-3xl overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <Heart className="w-24 h-24 text-blue-500 mx-auto mb-4 animate-pulse" />
              ...
              <div className="absolute top-4 right-4">
                <Stethoscope className="w-16 h-16 text-blue-300 opacity-50" />
              </div>
        ...
        >
          ...
          >
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg text-gray-600">
                Sai Sneh is equipped with sophisticated equipments including
              </p>
            </div>
