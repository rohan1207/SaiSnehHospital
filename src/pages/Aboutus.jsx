                  ...
                  <div className="p-8 md:p-12">
                    <div className="mb-8">
                      ...
                      <p className="text-lg text-gray-600 mb-6">
                        Dr. Sunil Jagtap is the owner of Sai Sneh Hospital &
                        Diagnostic Centre Pvt Ltd. He practices as a Homeopathy
                        doctor in the Hospital.
                      </p>
                    </div>
                    <div className="space-y-6">
                      {[
                        { label: "Speciality", value: "Homoeopath" },
                        {
                          label: "Education",
                          value:
