    ...
    >
      ...
      <div className="mt-8 sm:mt-16 bg-gradient-to-r from-red-50 to-orange-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <Link
            to="/contact"
            className="inline-flex items-center gap-2 bg-blue-500 text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-full text-sm sm:text-base font-semibold hover:bg-blue-600 transform transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
          >
            Contact Us
            <svg
