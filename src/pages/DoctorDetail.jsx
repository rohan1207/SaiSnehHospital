    ...
    <div className="bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-1">
            <img src={doctor.image} alt={doctor.name} className="w-full h-auto rounded-lg shadow-lg" />
          </div>
          <div className="md:col-span-2">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">{doctor.role}</h2>
            <p className="text-lg text-gray-600 mb-4">{doctor.experience}</p>
            <div className="mb-4">
              <h3 className="text-xl font-semibold text-gray-700 mb-2">Specialties</h3>
              <div className="flex flex-wrap gap-2">
                {doctor.specialties.map((specialty) => (
                  <span key={specialty} className="bg-red-100 text-red-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded">
                    {specialty}
                  </span>
                ))}
              </div>
