  ...
  if (!item) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center">
        ...
        <Link to="/" className="mt-4 text-red-500 hover:underline">Go back to Home</Link>
      </div>
    );
  }
  ...
  return (
    <div className="bg-gray-50 py-24 sm:py-32">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <Link to="/" className="inline-flex items-center gap-2 text-red-500 hover:text-red-700 transition-colors">
